...
@param props - see {@link SearchResultListItemExtensionsProps}`,methods:[],displayName:"SearchResultListItemExtensions",props:{results:{required:!0,tsType:{name:"Array",elements:[{name:"Result",elements:[{name:"SearchDocument"}],raw:"Result<SearchDocument>"}],raw:"SearchResult[]"},description:"Search result list."}}};const v=n=>{const{children:t}=n,e=w(),{result:r,...a}=e;return t(r,a)},X=n=>{const{query:t,children:e}=n,r=f(g),a=x(()=>{const{term:o="",types:u=[],filters:i={},...c}=t;return r.query({...c,term:o,types:u,filters:i})},[t]);return e(a,t)},d=n=>{const{query:t,children:e}=n;return t?s.jsx(X,{query:t,children:e}):s.jsx(v,{children:e})},S=n=>{const{t}=R(T),{query:e,children:r,noResultsComponent:a=s.jsx(_,{missing:"data",title:t("noResultsDescription")}),...o}=n;return s.jsx(d,{query:e,children:({loading:u,error:i,value:c})=>u?s.jsx(N,{}):i?s.jsx(P,{title:"Error encountered while fetching search results",error:i}):c?.results.length?y.isFunction(r)?r(c):s.jsx(h,{...o,results:c.results,children:r}):a})},J=n=>s.jsx(A,{attributes:{pluginId:"search",extension:"SearchResult"},children:s.jsx(S,{...n})});d.__docgenInfo={description:`Call a child render function passing a search state as an argument.
...
@param props - see {@link SearchResultProps}.
@public`,methods:[],displayName:"SearchResult",props:{children:{required:!1,tsType:{name:"union",raw:"ReactNode | ((resultSet: SearchResultSet) => JSX.Element)",elements:[{name:"ReactNode"},{name:"unknown"}]},description:""},noResultsComponent:{required:!1,tsType:{name:"JSX.Element"},description:""}}};export{d as S,J as a,te as c,D as u};
