import{j as e}from"./iframe-B9yZwi7m.js";import{S as o}from"./Select-D7Bu8sZO.js";import{F as x}from"./Flex-DCAfOqJq.js";import{$ as L}from"./FieldError-Dtyzs-P6.js";import{T as D}from"./provider-A9JIqovX.js";import"./preload-helper-D9Z9MdNV.js";import"./Button-DIr3bzM_.js";import"./utils-D1rkH_s0.js";import"./clsx-B-dksMZM.js";import"./Hidden-Bue8Lz36.js";import"./useFocusRing-CiqxV7xh.js";import"./usePress-Bj7YnqSO.js";import"./Collection-KKhmYblC.js";import"./FocusScope-CYFpsXo7.js";import"./context-UFl0AgBh.js";import"./useControlledState-BbsxchB3.js";import"./Input-BplVaL9p.js";import"./useFormReset-ikCrm8P2.js";import"./SearchField-D-JT1Guh.js";import"./Label-fmOIEJky.js";import"./TextField-DD5nPx2n.js";import"./useLabels-DhVEAI6o.js";import"./OverlayArrow-BwoDfgIQ.js";import"./VisuallyHidden-BEBxpHuW.js";import"./useStyles-BBr0Amad.js";import"./FieldLabel-DJCDstqk.js";import"./spacing.props-m9PQeFPu.js";const ie={title:"Backstage UI/Select",component:o},W=[{value:"sans",label:"Sans-serif"},{value:"serif",label:"Serif"},{value:"mono",label:"Monospace"},{value:"cursive",label:"Cursive"}],t={args:{options:W,name:"font"}},r={args:{label:"Font Family",options:W,placeholder:"Select a font",name:"font",style:{maxWidth:260}}},s={args:{...t.args,label:"Font Family"}},l={args:{...t.args,label:"Font Family",style:{width:"100%"}}},c={args:{...s.args,description:"Choose a font family for your document"}},d={args:{...s.args},render:a=>e.jsx(o,{...a,icon:e.jsx(D,{})})},m={args:{...r.args},render:a=>e.jsxs(x,{direction:"row",gap:"2",children:[e.jsx(o,{...a,size:"small",icon:e.jsx(D,{})}),e.jsx(o,{...a,size:"medium",icon:e.jsx(D,{})})]})},p={args:{...r.args,isRequired:!0}},u={args:{...r.args,isDisabled:!0}},g={args:{...r.args,disabledKeys:["cursive","serif"]}},h={args:{...r.args,options:void 0}},f={args:{...r.args,selectedKey:"mono",defaultSelectedKey:"serif"}},S={args:{...r.args,defaultSelectedKey:"serif",options:W,name:"font"}},I=(a=100)=>{const A=["Moon","Sun","Star","Cosmic","Globe","Flux","Nova","Echo","Pulse","Vertex","Nexus","Orbit","Prism","Quantum","Zenith","Aura","Crystal","Shadow","Phantom","Azure","Ember","Frost","Horizon","Mystic","Raven","Solstice","Tempest","Vortex","Whisper","Zephyr"],R=["green","blue","red","black","white","silver","gold","copper","bronze","steel","flow","light","dark","dream","stream","life","sight","mind","craft","blend","wave","swift","sharp","soft","bold","clear","deep","lift","shift","grace"],T=["Sans","Serif","Mono","Script","Display","Slab","Round","Thin","Bold","Italic","Pro","Neo","Prime","Plus","One","Two","Nova","Ultra","Elite","Max","Type","Text","View","Graph","Print","Read","Write","Book","Note","Letter"],F=n=>n[Math.floor(Math.random()*n.length)],w=Array.from({length:a}).map(()=>{const n=F(A),C=F(R),M=F(T);return`${n}${C} ${M}`}).reduce((n,C)=>(n.add(C),n),new Set).values();return Array.from(w).map(n=>({value:n.toLocaleLowerCase("en-US").replaceAll(" ","-"),label:n}))},y={args:{label:"Font Family",options:I(),name:"font"}},v={args:{...s.args,name:"font"},render:a=>e.jsx(L,{validationErrors:{font:"Invalid font family"},children:e.jsx(o,{...a})})},i={args:{label:"Document Template",options:[{value:"annual-report-2024",label:"Annual Financial Report and Strategic Planning Document for Fiscal Year 2024 with Comprehensive Analysis of Market Trends, Competitive Landscape, Financial Performance Metrics, Revenue Projections, Cost Optimization Strategies, Risk Assessment, and Long-term Growth Initiatives Across All Business Units and Geographical Regions"},{value:"product-roadmap",label:"Comprehensive Product Development Roadmap and Feature Implementation Timeline Including Detailed Technical Specifications, Resource Allocation Plans, Cross-functional Team Dependencies, Milestone Tracking, Quality Assurance Procedures, User Acceptance Testing Protocols, and Post-launch Support Strategy for All Product Lines and Service Offerings"},{value:"user-guide",label:"Detailed User Guide and Technical Documentation for Advanced System Features Covering Installation Procedures, Configuration Settings, Security Protocols, Troubleshooting Guidelines, Best Practices, Common Use Cases, Performance Optimization Tips, Integration Methods, API Documentation, and Frequently Asked Questions with Step-by-Step Solutions"},{value:"marketing-plan",label:"Integrated Marketing Strategy and Campaign Planning Document for Q3 2024 Encompassing Target Audience Analysis, Channel Selection Criteria, Budget Allocation Framework, Creative Development Process, Content Calendar, Social Media Strategy, Email Marketing Campaigns, SEO Optimization, Paid Advertising Plans, and ROI Measurement Methodology"},{value:"research-paper",label:"Scientific Research Paper on Advanced Machine Learning Techniques and Applications Including Literature Review, Methodology Description, Experimental Setup, Data Collection Procedures, Analysis Techniques, Results Interpretation, Comparative Studies, Limitations Discussion, Future Research Directions, and Practical Implementation Guidelines"}],placeholder:"Select a document template",name:"template",style:{maxWidth:400},defaultSelectedKey:"annual-report-2024"}},b={args:{...i.args},decorators:[(a,{args:A})=>e.jsx("div",{style:{padding:128},children:e.jsx(a,{...A})})]},P={args:{...t.args},render:a=>e.jsxs(x,{direction:"column",gap:"4",children:[e.jsxs("div",{children:[e.jsx("h3",{style:{marginBottom:8},children:"With aria-label"}),e.jsx(o,{...a,"aria-label":"Choose font family",placeholder:"Select a font family",name:"font-aria"})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{marginBottom:8},children:"With aria-labelledby"}),e.jsx("div",{id:"font-label",style:{marginBottom:8,fontWeight:600},children:"Font Family Selection"}),e.jsx(o,{...a,"aria-labelledby":"font-label",placeholder:"Select a font family",name:"font-labelledby"})]})]})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    options: fontOptions,
    name: 'font'
  }
...
}`,...P.parameters?.docs?.source}}};const le=["Default","Preview","WithLabel","WithFullWidth","WithLabelAndDescription","WithIcon","Sizes","Required","Disabled","DisabledOption","NoOptions","WithValue","WithDefaultValue","WithManyOptions","WithError","WithLongNames","WithLongNamesAndPadding","WithAccessibilityProps"];export{t as Default,u as Disabled,g as DisabledOption,h as NoOptions,r as Preview,p as Required,m as Sizes,P as WithAccessibilityProps,S as WithDefaultValue,v as WithError,l as WithFullWidth,d as WithIcon,s as WithLabel,c as WithLabelAndDescription,i as WithLongNames,b as WithLongNamesAndPadding,y as WithManyOptions,f as WithValue,le as __namedExportsOrder,ie as default};
