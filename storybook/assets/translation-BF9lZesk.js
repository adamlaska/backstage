import{p as d,s as h}from"./ref-C0VTUPuL.js";import{j as r,q as c,ab as p,ac as u,i as y}from"./iframe-B9yZwi7m.js";import{A as f}from"./useAnalytics-B4wZ5pc1.js";const T="parentOf",k="memberOf";function q(e,t,i){let a=e?.relations?.filter(n=>n.type===t).map(n=>d(n.targetRef))||[];return i?.kind&&(a=a.filter(n=>n.kind.toLocaleLowerCase("en-US")===i.kind.toLocaleLowerCase("en-US"))),a}const m=p("entity-context"),s=e=>{const{children:t,entity:i,loading:a,error:n,refresh:o}=e,l={entity:i,loading:a,error:n,refresh:o};return r.jsx(m.Provider,{value:u({1:l}),children:r.jsx(f,{attributes:{...i?{entityRef:h(i)}:void 0},children:t})})},g=e=>r.jsx(s,{entity:e.entity,loading:!e.entity,error:void 0,refresh:void 0,children:e.children});function A(){const e=c("entity-context");if(!e)throw new Error("Entity context is not available");const t=e.atVersion(1);if(!t)throw new Error("EntityContext v1 not available");if(!t.entity)throw new Error("useEntity hook is being called outside of an EntityLayout where the entity has not been loaded. If this is intentional, please use useAsyncEntity instead.");return{entity:t.entity}}s.__docgenInfo={description:"Provides a loaded entity to be picked up by the `useEntity` hook.\n\n@public",methods:[],displayName:"AsyncEntityProvider",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},entity:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  /**
...
various ways.`},{key:"links",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
   ...
   */
  targetRef: string;
}`,signature:{properties:[{key:"type",value:{name:"string",required:!0},description:"The type of the relation."},{key:"targetRef",value:{name:"string",required:!0},description:"The entity ref of the target of this relation."}]}}],raw:"EntityRelation[]",required:!1},description:"The relations that this entity has with other entities."}]}},description:""},loading:{required:!0,tsType:{name:"boolean"},description:""},error:{required:!1,tsType:{name:"Error"},description:""},refresh:{required:!1,tsType:{name:"VoidFunction"},description:""}}};g.__docgenInfo={description:"Provides an entity to be picked up by the `useEntity` hook.\n\n@public",methods:[],displayName:"EntityProvider",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},entity:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  /**
   * The version of specification format for this particular entity that
   * this is written against.
   */
