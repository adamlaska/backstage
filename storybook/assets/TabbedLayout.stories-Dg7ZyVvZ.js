import{r as b,j as e,a as f}from"./iframe-tbK3y8nX.js";import{H as x}from"./Helmet-Bc0xIq1y.js";import{L as R}from"./Link-DE5azwbI.js";import{H as j}from"./HeaderTabs-BKqa_B1t.js";import{e as g,f as L,m as v,M as E,R as P,a as w}from"./index-CRcpJ08W.js";import{a as _}from"./componentData-BJunciA8.js";import"./preload-helper-D9Z9MdNV.js";import"./lodash-CwBbdt2Q.js";import"./useAnalytics-Ca8LGS_G.js";import"./useApp-GTt_SpSe.js";import"./Box-BCZ-oNFO.js";import"./styled-M6G78zdi.js";import"./Tabs-B2QVtPR9.js";import"./index-DnL3XN75.js";import"./KeyboardArrowRight-DvbsjYZ4.js";function k(t){const a=g(),s=t.map(({path:r,children:m})=>({caseSensitive:!1,path:`${r}/*`,element:m})).sort((r,m)=>m.path.replace(/\/\*$/,"").localeCompare(r.path.replace(/\/\*$/,""))),d=L(s)??t[0]?.children;let n=a["*"]??"";n.startsWith("/")||(n=`/${n}`);const[i]=v(s,n)??[],p=i?t.findIndex(r=>`${r.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=k(a),n=b.useMemo(()=>a.map(i=>{const{path:p,title:r,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:r,tabProps:{component:R,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(j,{tabs:n,selectedIndex:o}),e.jsxs(f,{children:[e.jsx(x,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
