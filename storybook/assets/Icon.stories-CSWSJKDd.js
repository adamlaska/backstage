import{j as e}from"./iframe-jWBis4h7.js";import{I as a,i as n,b as t}from"./provider-CQsiGRUU.js";import"./preload-helper-D9Z9MdNV.js";import"./clsx-B-dksMZM.js";import"./useStyles-BQS053Tg.js";const u={title:"Backstage UI/Icon",component:a,argTypes:{name:{control:"select",options:Object.keys(n)}},args:{name:"heart"}},r={args:{name:"heart"}},o={args:{name:"arrow-down"},decorators:[s=>e.jsx(t,{overrides:{"arrow-down":()=>e.jsx("div",{children:"Custom Icon"})},children:e.jsx(s,{})})]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    name: 'heart'
  }
