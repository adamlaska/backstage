import{j as e}from"./iframe-tbK3y8nX.js";import{S as r}from"./ScrollArea-frItO6yN.js";import{T as a}from"./Text-DuTHiLdC.js";import"./preload-helper-D9Z9MdNV.js";import"./clsx-B-dksMZM.js";import"./useStyles-BDf2UKvS.js";import"./useBaseUiId-D-AB9Z3U.js";const u={title:"Backstage UI/ScrollArea",component:r.Root},t={render:()=>e.jsxs(r.Root,{style:{width:"24rem",height:"8.5rem"},children:[e.jsx(r.Viewport,{style:{border:"1px solid var(--bui-border)",borderRadius:"4px"},children:e.jsxs("div",{style:{padding:"0.75rem",paddingRight:"1.5rem"},children:[e.jsx(a,{style:{paddingBottom:"1rem"},children:"Vernacular architecture is building done outside any academic tradition, and without professional guidance. It is not a particular architectural movement or style, but rather a broad category, encompassing a wide range and variety of building types, with differing methods of construction, from around the world, both historical and extant and classical and modern. Vernacular architecture constitutes 95% of the world's built environment, as estimated in 1995 by Amos Rapoport, as measured against the small percentage of new buildings every year designed by architects and built by engineers."}),e.jsx(a,{children:"This type of architecture usually serves immediate, local needs, is constrained by the materials available in its particular region and reflects local traditions and cultural practices. The study of vernacular architecture does not examine formally schooled architects, but instead that of the design skills and tradition of local builders, who were rarely given any attribution for the work. More recently, vernacular architecture has been examined by designers and the building industry in an effort to be more energy conscious with contemporary design and construction—part of a broader interest in sustainable design."})]})}),e.jsx(r.Scrollbar,{orientation:"vertical",children:e.jsx(r.Thumb,{})})]})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => <ScrollArea.Root style={{
    width: '24rem',
    height: '8.5rem'
  }}>
...
}`,...t.parameters?.docs?.source}}};const h=["Default"];export{t as Default,h as __namedExportsOrder,u as default};
